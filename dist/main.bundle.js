  ...
  _createClass(CookieControls, [{
    ...
    value: function deleteCookie() {
      if (typeof _globalArray2.default.globalArray['main'] !== 'undefined') {
        $.getJSON(new _codeComp2.default().mainCode() + '&localcode=' + this.getCookie("localSecureId") + '&user=' + this.getCookie('user') + '&action=logout');
      }
...
var _listing = __webpack_require__(16);
